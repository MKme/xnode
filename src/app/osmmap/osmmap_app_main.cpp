...
static void osmmap_create_local_position_marker( lv_obj_t *parent ) {
    ...
    lv_img_set_antialias( osmmap_app_pos_img, true );
...
static void osmmap_refresh_marker_positions( void ) {
    ...
    osmmap_local_marker_visible = false;
    if ( osmmap_app_pos_img && osmmap_have_local_position ) {
        uint16_t marker_x = 0;
        uint16_t marker_y = 0;
...
void osmmap_app_main_setup( uint32_t tile_num ) {
...
#if defined( LILYGO_WATCH_ULTRA )
    lv_style_set_text_color(&osmmap_app_label_style, LV_OBJ_PART_MAIN, LV_COLOR_WHITE );
    lv_style_set_bg_color( &osmmap_app_label_style, LV_OBJ_PART_MAIN, LV_COLOR_BLACK );
    lv_style_set_bg_opa( &osmmap_app_label_style, LV_OBJ_PART_MAIN, LV_OPA_80 );
    lv_style_set_radius( &osmmap_app_label_style, LV_OBJ_PART_MAIN, 3 );
    lv_style_set_pad_left( &osmmap_app_label_style, LV_STATE_DEFAULT, 4 );
    lv_style_set_pad_right( &osmmap_app_label_style, LV_STATE_DEFAULT, 4 );
    lv_style_set_pad_top( &osmmap_app_label_style, LV_STATE_DEFAULT, 2 );
    lv_style_set_pad_bottom( &osmmap_app_label_style, LV_STATE_DEFAULT, 2 );
#else
...
#if defined( LILYGO_WATCH_ULTRA )
    lv_img_set_pivot( osmmap_ext_pos_img, 8, 8 );
    lv_img_set_zoom( osmmap_ext_pos_img, 512 );
    lv_img_set_antialias( osmmap_ext_pos_img, true );
#endif
    lv_obj_align( osmmap_ext_pos_img, osmmap_overlay_layer, LV_ALIGN_IN_TOP_LEFT, 120, 120 );
    lv_obj_set_hidden( osmmap_ext_pos_img, true );

#if defined( LILYGO_WATCH_ULTRA )
    osmmap_gps_status_panel = lv_obj_create( osmmap_overlay_layer, NULL );
    lv_obj_set_size( osmmap_gps_status_panel, osmmap_view_w - 48, 42 );
    lv_obj_set_click( osmmap_gps_status_panel, false );
    lv_obj_set_style_local_bg_color( osmmap_gps_status_panel, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_BLACK );
    lv_obj_set_style_local_bg_opa( osmmap_gps_status_panel, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_COVER );
    lv_obj_set_style_local_border_width( osmmap_gps_status_panel, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, 2 );
    lv_obj_set_style_local_border_color( osmmap_gps_status_panel, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_WHITE );
    lv_obj_set_style_local_radius( osmmap_gps_status_panel, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, 3 );
    lv_obj_set_style_local_pad_all( osmmap_gps_status_panel, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, 0 );
    lv_obj_align( osmmap_gps_status_panel, osmmap_overlay_layer, LV_ALIGN_IN_TOP_MID, 0, 6 );

    osmmap_lonlat_label = lv_label_create( osmmap_gps_status_panel, NULL );
    lv_obj_add_style( osmmap_lonlat_label, LV_OBJ_PART_MAIN, &osmmap_app_label_style );
    lv_obj_set_style_local_text_color( osmmap_lonlat_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_WHITE );
    lv_obj_set_style_local_text_font( osmmap_lonlat_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &Ubuntu_12px );
    lv_obj_set_style_local_bg_opa( osmmap_lonlat_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_TRANSP );
    lv_obj_set_width( osmmap_lonlat_label, osmmap_view_w - 58 );
    lv_label_set_long_mode( osmmap_lonlat_label, LV_LABEL_LONG_BREAK );
    lv_label_set_align( osmmap_lonlat_label, LV_LABEL_ALIGN_CENTER );
    lv_obj_align( osmmap_lonlat_label, osmmap_gps_status_panel, LV_ALIGN_CENTER, 0, 0 );
    lv_label_set_text( osmmap_lonlat_label, "GPS OFF\nNO POS" );
    lv_obj_move_foreground( osmmap_gps_status_panel );
#else
    ...
    gpsctl_register_cb( GPSCTL_ENABLE | GPSCTL_DISABLE | GPSCTL_FIX | GPSCTL_NOFIX | GPSCTL_SET_APP_LOCATION | GPSCTL_UPDATE_LOCATION | GPSCTL_UPDATE_COURSE | GPSCTL_UPDATE_SATELLITE, osmmap_gpsctl_event_cb, "osm" );
