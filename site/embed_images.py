...
ASSETS = {
    "images/xnode-hero.webp": ("image/webp", ROOT / "images" / "xnode-hero.webp"),
    "images/xnode-watch-screens.webp": ("image/webp", ROOT / "images" / "xnode-watch-screens.webp"),
    "images/xnode-system-flow.svg": ("image/svg+xml", ROOT / "images" / "xnode-system-flow.svg"),
}
