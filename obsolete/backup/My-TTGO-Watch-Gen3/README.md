...
The active LilyGO Watch Gen3 work, including the XNODE watch-flash basemap install flow, is documented in [GEN3_README.md](C:\GitHub\lilygo\My-TTGO-Watch-Gen3\GEN3_README.md).
