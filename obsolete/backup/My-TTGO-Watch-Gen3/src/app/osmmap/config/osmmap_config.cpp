...
bool osmmap_config_t::onSave(JsonDocument& doc) {
    ...
    doc["osmmap"] = osmmap;
    doc["watch_flash_basemap_valid"] = watch_flash_basemap_valid;
    doc["watch_flash_lon"] = watch_flash_lon;
    doc["watch_flash_lat"] = watch_flash_lat;
    doc["watch_flash_zoom"] = watch_flash_zoom;
    return true;
}
...
bool osmmap_config_t::onLoad(JsonDocument& doc) {
    ...
    watch_flash_basemap_valid = doc["watch_flash_basemap_valid"] | false;
...
bool osmmap_config_t::onDefault( void ) {
    ...
    watch_flash_basemap_valid = false;
    watch_flash_lon = 0.0;
    watch_flash_lat = 0.0;
    watch_flash_zoom = 10;
    return true;
