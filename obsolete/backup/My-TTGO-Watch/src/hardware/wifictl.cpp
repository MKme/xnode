...
#include "utils/ftpserver/ftpserver.h"
    ...
    #include <esp_wps.h>
        ...
        #define HEDGE_EVENT_WIFI_READY              WiFiEvent_t::ARDUINO_EVENT_WIFI_READY
        #define HEDGE_EVENT_WIFI_SCAN_DONE          WiFiEvent_t::ARDUINO_EVENT_WIFI_SCAN_DONE
        #define HEDGE_EVENT_WIFI_STA_STOP           WiFiEvent_t::ARDUINO_EVENT_WIFI_STA_STOP
        #define HEDGE_EVENT_WIFI_STA_DISCONNECTED   WiFiEvent_t::ARDUINO_EVENT_WIFI_STA_DISCONNECTED
        #define HEDGE_EVENT_WIFI_STA_GOT_IP         WiFiEvent_t::ARDUINO_EVENT_WIFI_STA_GOT_IP
        #define HEDGE_EVENT_WPS_ER_SUCCESS          WiFiEvent_t::ARDUINO_EVENT_WPS_ER_SUCCESS
        #define HEDGE_EVENT_WPS_ER_FAILED           WiFiEvent_t::ARDUINO_EVENT_WPS_ER_FAILED
        #define HEDGE_EVENT_WPS_ER_TIMEOUT          WiFiEvent_t::ARDUINO_EVENT_WPS_ER_TIMEOUT
    #else
        #define HEDGE_EVENT_WIFI_READY              WiFiEvent_t::SYSTEM_EVENT_WIFI_READY
        #define HEDGE_EVENT_WIFI_SCAN_DONE          WiFiEvent_t::SYSTEM_EVENT_SCAN_DONE
        #define HEDGE_EVENT_WIFI_STA_STOP           WiFiEvent_t::SYSTEM_EVENT_STA_STOP
        #define HEDGE_EVENT_WIFI_STA_DISCONNECTED   WiFiEvent_t::SYSTEM_EVENT_STA_DISCONNECTED
        #define HEDGE_EVENT_WIFI_STA_GOT_IP         WiFiEvent_t::SYSTEM_EVENT_STA_GOT_IP
        #define HEDGE_EVENT_WPS_ER_SUCCESS          WiFiEvent_t::SYSTEM_EVENT_STA_WPS_ER_SUCCESS
        #define HEDGE_EVENT_WPS_ER_FAILED           WiFiEvent_t::SYSTEM_EVENT_STA_WPS_ER_FAILED
        #define HEDGE_EVENT_WPS_ER_TIMEOUT          WiFiEvent_t::SYSTEM_EVENT_STA_WPS_ER_TIMEOUT
    #endif
...
void wifictl_setup( void ) {
    ...
    WiFi.onEvent([](WiFiEvent_t event, WiFiEventInfo_t info) {
        ...
        }, HEDGE_EVENT_WIFI_STA_DISCONNECTED);
...
void wifictl_start_wps( void ) {
    ...
    */
    ...
    #else
        esp_wps_config.wps_type = WPS_TYPE_PBC;
    #endif
